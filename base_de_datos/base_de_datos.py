...
horario_empleado1 = clases.horario_empleado.Horario_empleado(['00:00'], ['16:00'])
horario_empleado2 = clases.horario_empleado.Horario_empleado(['00:00'], ['17:00'])
...
obra1 = clases.obra.Obra('5m', '2m', '123456afd', 'cuadro y', 2, '01:00', '20/10/2020', '20/10/2020', 'la gioconda', '500kg', '$2321,5 pesos', empleado1)
obra2 = clases.obra.Obra('4m', '3m', '000456afd', 'cuadro y', 3, '00:45','20/09/2020', '20/09/2020', 'la gioconda 2', '5kg', '$100000 pesos', empleado2)
...
exposicion1 = clases.exposicion.Exposicion('2021-07-12', '2021-08-23', '2021-07-12', '2021-08-23', '08:00:10','12:41:09', 'exposicion 1', detalle_exposicion1, tipoExposicion1, [publicoDestino1, publicoDestino2])
exposicion2 = clases.exposicion.Exposicion('2021-05-20', '2021-06-20', '2021-05-20', '2021-06-20', '08:00:12','21:00:19', 'exposicion 2', detalle_exposicion2, tipoExposicion2, [publicoDestino1])
...
escuela1=clases.escuela.Escuela('Barrio las Flores','escuela@.com', 'Colegio Parroquial San Francisco De Asis', '351987987', '351654654')
escuela2=clases.escuela.Escuela('Centro','escuela3@.com', 'Colegio Manuel Belgrano', '358988582', '358644457')
