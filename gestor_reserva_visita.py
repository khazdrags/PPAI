...
print('\n------------------buscar escuelas')
print(gestorReservaVisita1.buscar_escuelas())
print('\n------------------tomar escuela')
print(gestorReservaVisita1.tomar_escuela(BD.escuela1))
print('\n------------------tomar cantidad')
print(gestorReservaVisita1.tomar_cant_visitantes(50))
print('\n------------------buscar sede')
print(gestorReservaVisita1.buscar_sede())
print('\n------------------tomar sede')
print(gestorReservaVisita1.tomar_sede(BD.sede1))
print('\n------------------buscar tipo visita')
print(gestorReservaVisita1.buscar_tipo_visita())
print('\n------------------ tomar tipo visita')
print(gestorReservaVisita1.tomar_tipo_visita(BD.tipo_visita1))
